                            ...
                            <div class="flex flex-col md:flex-row max-w-1200 w-full mx-auto relative postslist">
                                ...
                                <div class="w-full md:w-4/5 p-2">
                                    ...
                                    <div class="text-black md:pl-20 block">
                                        ...
                                        <div class="flex authors_view">
                                            <div class="w-1/7 mr-6">
                                                <a :href="edge.node.author.path" :to="edge.node.author.path">
                                                    <img :src="`${edge.node.author.authorImage}`" style=" border-radius: 50%; position: relative; top: 50%; transform: translateY(-50%);" class="w-16" />
                                                </a>
                                            </div>
                                            <div class="md:w-2/3 authorname">
                                                ...
                                                <p v-text="edge.node.author.position" class="font-normal" />
