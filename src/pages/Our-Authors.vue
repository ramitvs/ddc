...
<template>
    <Layout>
        ...
        <section class="sm:px-2 px-6 xl:px-0 py-6" id="current_post">
            <div class="max-w-1200 w-full mx-auto md:px-6">
                <h1 class="justify-center text-3xl capitalize font-bold" style="text-align: center;">Our Authors</h1>
               <br>
                <p class="font-normal pb-12 px-6" style="border-bottom: 1px solid #80808047;"  id="current-post">DDC authors write compelling stories about cutting edge technologies & trends, people, products, events, and topic that is valuable to our customers, employees and partners.</p>
                <div class="flex flex-row flex-wrap pt-8 pb-8 font-semibold px-2 authors_list">
                    ...
                    <div v-for="(edge, key) in searchResults ? searchResults : $page.allAuthor.edges" :key="edge.node.id" class="authors_list flex flex-col w-full relative current-post pb-10">
                                ...
                                <div class="text-black">
                                    ...
                                    <div class="">
                                        ...
                                        <div v-show="!edge.Flag">
                                            ...
                                            <p class="rfs-text-base leading-tight  font-normal author-about" style="margin-bottom: 15px;" v-html="edge.node.authorAbout"></p>
                                            <p class="rfs-text-base leading-tight font-normal  author-about" style="margin-bottom: 15px;" v-html="edge.node.authorInterest"></p>
                                            <p class="rfs-text-base leading-tight font-normal  author-about" v-html="edge.node.authorExperience"></p></div>
                                            <span  class="read_more brighter-teal btn rfs-text-base leading-tight font-normal" @click="toggler(edge, true);">Read More..</span>
                                        </div>
                                        <!-- Excerpt section end -->
                                        <!-- Content section -->
                                    <div v-show="edge.Flag">
                                        <p class="rfs-text-base leading-tight  font-normal author-about" style="margin-bottom: 15px;" v-html="edge.node.authorAbout"></p>
                                        <p class="rfs-text-base leading-tight font-normal  author-about" style="margin-bottom: 15px;" v-html="edge.node.authorInterest"></p>
                                        <p class="rfs-text-base leading-tight font-normal  author-about" v-html="edge.node.authorExperience"></p>
                                        <span class="read_more brighter-teal btn rfs-text-base leading-tight font-normal" @click="toggler(edge, false);">Read Less</span>
                                    </div>
                                        <!-- Content section end-->
                                        <div class="">
