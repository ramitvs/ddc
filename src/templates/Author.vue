...
<template>
    <Layout>
        ...
        <section class="px-4 xl:px-0 bg-white pb-20 md:pt-0" style="border-bottom: 1px solid #0000002e;">
        ...
        <section class="px-4 xl:px-0 pb-0 py-16">
                                ...
                                <div class="text-black md:pl-20 block">
                                    <template v-if="edge.node.categories">
                                        <div class="categorieslist">
                                            <a v-for="(category) in edge.node.categories" :key="category.id" v-text="category.title === 'guest-blog' ? 'Guest Blog' : category.title"   :href="`/categories/${category.title}`" class="categorylist capitalize font-bold brighter-teal block mb-6 md:mr-6" />
                                        </div>
                                    </template>
                                    <g-link :to="edge.node.path">
                                        <h2 class="post-card__title pb-0 text-xl font-bold text-left" v-html="edge.node.title" />
