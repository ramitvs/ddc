    ...
    <Layout>
        ...
        <section class="px-6 xl:px-0 bg-white pb-8 pt-20" style="border-bottom: 1px solid #0000002e; margin-top: 0px;">
            <div class="max-w-1000 w-full mx-auto">
                <h1 class="w-full text-3xl  font-black capitalize text-black" style="margin:auto;text-align:center" v-text="$page.category.title === 'guest-blog' ? 'Guest Blog' : $page.category.titlee"  />
                <br />
            </div>
